...
int main(int argc, char * argv[]){
    ...
    unsigned int count = database.Make_Index_Add(databasepath, group);
    database.Out_Index(newindexname);
    
    cout << count << " Items are added into the index, there are " << database.Get_Entry_Count() << " items in total" << endl; 
